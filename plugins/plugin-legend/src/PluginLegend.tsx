...
import { PluginLegendProps, PluginLegendStylesProps } from './types';
...
const Styles = styled.div<PluginLegendStylesProps>`
...
export default class PluginLegend extends PureComponent<PluginLegendProps> {
